...
As can be seen the __flipper_length_mm__ is not statistically significant. We 
can remove this predictor and train again the model. 



```{r}
penguin_train <- penguin_train %>%  select(- flipper_length_mm)
...
predicted_sex <-
ifelse(test = predicted_porb > 0.5, yes = "male", "female")
